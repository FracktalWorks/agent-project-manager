...
| Script | Purpose |
|---|---|
| `skills/project-planning/scripts/plan_project.py` | Generates structured project plan JSON |
...
4. For each task: assign estimated effort (hours), suggest owner role (see `hr-structure` skill), set due date.
