...
> **This skill is the lightweight session interface.** For the full dual-tier architecture, risk log, decision journal, and follow-up schemas, see `.github/skills/project-memory/SKILL.md`.
