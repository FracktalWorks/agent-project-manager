...
Usage:
    python skills/hr-structure/scripts/query_hr.py --skill Python
    python skills/hr-structure/scripts/query_hr.py --role "Senior Engineer"
    python skills/hr-structure/scripts/query_hr.py --available-hours 8
    python skills/hr-structure/scripts/query_hr.py --list-all
"""
